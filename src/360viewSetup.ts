...
export const setup360 = (folderNumber: string): Entity => {
    ...
    //root
  let skyboxRoot: Entity = skyboxRoot1// = engine.addEntity()
  ...
  switch (folderNumber) {
    ...
    case "2":
      ...
      Transform.create(cloudFloor, { position: Vector3.create(0, 0, 0) })
  ...
  Transform.create(skyboxRoot, { position: Vector3.create(sceneSizeX/4 , height/2 , sceneSizeZ/4 ) })
