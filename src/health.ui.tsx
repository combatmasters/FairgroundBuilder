        ...
        >
            <UiEntity 
                ...
                >
                  ...
                  <Label
                    onMouseDown={() => {
                      console.log('RADISH_SEED Label clicked!')
                      //groundVar.seed = Item.RADISH_SEED
                      //onst sproutData = [groundVar.groundPos.position, "radishSeed"]
                      //roomVar.send("sprout", sproutData);  
                      //visiblePlantingTab = false
                      //console.log("sprout sent")
        ...
        >
            <UiEntity 
                ...
                >
                  ...
                  <Label
                    onMouseDown={() => {
                      console.log('CARROT_SEED Label clicked!')
                      //groundVar.seed = Item.CARROT_SEED
                      //const sproutData = [groundVar.groundPos.position, "carrotSeed"]
                      //roomVar.send("sprout", sproutData);  
                      //visiblePlantingTab = false
                      //console.log("sprout sent")
                      //console.log(sproutData)
        ...
        >
            <UiEntity 
                ...
                >
                  ...
                  <Label
                    onMouseDown={() => {
                      console.log('MELON_SEED Label clicked!')
                      //groundVar.seed = Item.MELON_SEED
                      //const sproutData = [groundVar.groundPos.position, "melonSeed"]
                      //roomVar.send("sprout", sproutData);  
                      //visiblePlantingTab = false
                      //console.log("sprout sent")
                      //console.log(sproutData)
            ...
            <UiEntity 
                ...
                >
                  ...
                  <Label
                    onMouseDown={() => {
                      console.log('PINEAPPLE_SEED Label clicked!')
                      //groundVar.seed = Item.PINEAPPLE_SEED
                      //const sproutData = [groundVar.groundPos.position, "pineappleSeed"]
                      //roomVar.send("sprout", sproutData);  
                      //visiblePlantingTab = false
                      //console.log("sprout sent")
                      //console.log(sproutData)
          ...
          >
            <UiEntity 
                ...
                >
                  ...
                  <Label
                    onMouseDown={() => {
                      console.log('CORN_SEED Label clicked!')
                      //groundVar.seed = Item.CORN_SEED
                      //const sproutData = [groundVar.groundPos.position, "cornSeed"]
                      //roomVar.send("sprout", sproutData);  
                      //visiblePlantingTab = false
                      //console.log("sprout sent")
                      //console.log(sproutData)
